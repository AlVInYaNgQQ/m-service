...
@Module({
  imports: [TestModule, TestModuleModule, TestRestapiResourceModule, TestGraphQlCodeResourceModule, TestGraphQlSchemaResourceModule, TestMicroserviceResourceModule, TestWebsocketResourceModule],
  controllers: [AppController],
  providers: [AppService, TestGatewayGateway, TestProvider, TestResolverResolver, TestServiceService],
})
