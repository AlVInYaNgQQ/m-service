...
export class TestGraphQlCodeResourceResolver {
  constructor(private readonly testGraphQlCodeResourceService: TestGraphQlCodeResourceService) {}

  @Mutation(() => TestGraphQlCodeResource)
  createTestGraphQlCodeResource(@Args('createTestGraphQlCodeResourceInput') createTestGraphQlCodeResourceInput: CreateTestGraphQlCodeResourceInput) {
    return this.testGraphQlCodeResourceService.create(createTestGraphQlCodeResourceInput);
  }
  ...
  @Mutation(() => TestGraphQlCodeResource)
  updateTestGraphQlCodeResource(@Args('updateTestGraphQlCodeResourceInput') updateTestGraphQlCodeResourceInput: UpdateTestGraphQlCodeResourceInput) {
    return this.testGraphQlCodeResourceService.update(updateTestGraphQlCodeResourceInput.id, updateTestGraphQlCodeResourceInput);
  }
