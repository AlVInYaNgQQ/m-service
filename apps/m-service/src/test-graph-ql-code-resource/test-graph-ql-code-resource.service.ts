...
export class TestGraphQlCodeResourceService {
  create(createTestGraphQlCodeResourceInput: CreateTestGraphQlCodeResourceInput) {
  ...
  update(id: number, updateTestGraphQlCodeResourceInput: UpdateTestGraphQlCodeResourceInput) {
