...
export class TestGraphQlSchemaResourceResolver {
  constructor(private readonly testGraphQlSchemaResourceService: TestGraphQlSchemaResourceService) {}

  @Mutation('createTestGraphQlSchemaResource')
  create(@Args('createTestGraphQlSchemaResourceInput') createTestGraphQlSchemaResourceInput: CreateTestGraphQlSchemaResourceInput) {
    return this.testGraphQlSchemaResourceService.create(createTestGraphQlSchemaResourceInput);
  }
  ...
  update(@Args('updateTestGraphQlSchemaResourceInput') updateTestGraphQlSchemaResourceInput: UpdateTestGraphQlSchemaResourceInput) {
    return this.testGraphQlSchemaResourceService.update(updateTestGraphQlSchemaResourceInput.id, updateTestGraphQlSchemaResourceInput);
  }
