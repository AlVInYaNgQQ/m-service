...
export class TestMicroserviceResourceController {
  constructor(private readonly testMicroserviceResourceService: TestMicroserviceResourceService) {}

  @MessagePattern('createTestMicroserviceResource')
  create(@Payload() createTestMicroserviceResourceDto: CreateTestMicroserviceResourceDto) {
    return this.testMicroserviceResourceService.create(createTestMicroserviceResourceDto);
  }
  ...
  update(@Payload() updateTestMicroserviceResourceDto: UpdateTestMicroserviceResourceDto) {
    return this.testMicroserviceResourceService.update(updateTestMicroserviceResourceDto.id, updateTestMicroserviceResourceDto);
  }
