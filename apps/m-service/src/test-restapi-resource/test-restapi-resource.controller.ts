...
export class TestRestapiResourceController {
  constructor(private readonly testRestapiResourceService: TestRestapiResourceService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateTestRestapiResourceDto: UpdateTestRestapiResourceDto) {
    return this.testRestapiResourceService.update(+id, updateTestRestapiResourceDto);
  }
