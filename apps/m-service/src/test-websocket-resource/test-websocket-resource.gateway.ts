...
export class TestWebsocketResourceGateway {
  ...
  create(
    ...
    return this.testWebsocketResourceService.create(
  ...
  update(
    ...
    return this.testWebsocketResourceService.update(
      updateTestWebsocketResourceDto.id,
      updateTestWebsocketResourceDto,
    );
  }
